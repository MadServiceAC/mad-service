            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <ul className="font-medium">
                        <li className="mb-4">
                        <a href="/shop" className="hover:underline cursor-pointer">Detail Produk</a>
                        </li>
                    </ul>
                    </div>
                    <div className="text-center lg:text-left">
                    ...
                    <ul className="font-medium">
                        <li className="mb-4">
                        <a href="/service" className="hover:underline cursor-pointer">Daftar Teknisi</a>
                        </li>
                        <li className="mb-4">
                        <a href="/service" className="hover:underline cursor-pointer">Daftar Peralatan</a>
                        </li>
                        <li className="mb-4">
                        <a href="/service" className="hover:underline cursor-pointer">Pemesanan</a>
                        </li>
                        <li>
                        <a href="/forum" className="hover:underline cursor-pointer">Forum Diskusi</a>
                        </li>
                    </ul>
                    </div>
                    <div className="text-center lg:text-left">
                    ...
                    <ul className="font-medium">
                        ...
                        <li className="mb-4 flex items-center">
                        <p href="#" className="hover:underline flex items-center">
