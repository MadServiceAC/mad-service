...
import helmetman from './assets/icons/helmetman.png'
import GridContainer from './components/grid/GridContainer'
import images from "./components/handlers/IconHandler"
...
const items = [
  { imageSrc: images.ccac, title: "Cuci AC", description: "Membersihkan filter, evaporator, dan kondensor AC secara menyeluruh." },
  { imageSrc: images.psac, title: "Pasang AC", description: "Memasang AC baru dengan tepat dan aman." },
  { imageSrc: images.rpac, title: "Perbaikan AC", description: "Mendiagnosis kerusakan AC secara akurat." },
  { imageSrc: images.ckac, title: "Pengecekan", description: "Memeriksa kondisi AC secara menyeluruh." },
  { imageSrc: images.isfr, title: "Isi Freon", description: "Menambahkan freon ke dalam AC sesuai dengan kebutuhan." },
  { imageSrc: images.rpbs, title: "Service Besar", description: "Melakukan kombinasi dari beberapa layanan servis." },
];
        ...
        <div className='flex flex-col'>
          ...
          <div>
            ...
            <div className='flex flex-col p-2 items-center text-center'>
              <img src={helmetman} alt='Professional team' className='w-16'/>
            ...
            <div className='flex flex-col p-2 items-center text-center'>
              <img src={clock} alt='fullday availability' className='w-16'/>
